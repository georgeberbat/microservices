...
namespace Identity.Controllers.Account
{
    ...
    public class ExternalController : Controller
    {
        ...
        public async Task<IActionResult> Callback()
        {
            ...
            await _events.RaiseAsync(new UserLoginSuccessEvent(provider, providerUserId, user.Sub, user.Name, true, context?.Client.ClientId));
        ...
        private (User user, string provider, string providerUserId, IEnumerable<Claim> claims) FindUserFromExternalProvider(AuthenticateResult result)
        {
            ...
            // find external user
            var user = _userStoreClient.FindByExternalProvider(new UserFilterByProvider() {Provider = provider, UserId = providerUserId});
